...
const Hero = () => {
  return (
    <motion.section
      id="hero"
      className="w-full min-h-screen flex flex-col justify-center items-center text-center pt-6 md:pt-12 pb-6 md:pb-12 relative z-10 scroll-snap-start px-2 lg:max-w-screen-lg lg:mx-auto"
    ...
    >
      ...
      >
        ...
        <div className="flex justify-center items-center gap-4 md:gap-6 mb-6">
          <h1 className="text-5xl md:text-8xl font-extrabold text-stone-700 leading-tight m-0">
            ZhyingLu
          </h1>
          <img
            src="/avatar.JPG"
            alt="avatar"
            className="w-16 h-16 md:w-20 md:h-20 rounded-full border-4 border-stone-200 object-cover shadow"
          />
        </div>
        <h2 className="text-2xl md:text-5xl font-bold text-stone-900 mb-6 md:mb-8">

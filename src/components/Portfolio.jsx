...
const Portfolio = () => {
  return (
    <motion.section
      id="portfolio"
      className="w-full min-h-screen flex flex-col justify-center items-center my-0 py-0 scroll-snap-start px-2 lg:max-w-screen-lg lg:mx-auto"
    ...
    >
      ...
      <div className="w-full grid gap-4 sm:gap-6 md:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
